...
def main():
    ...
    json_file_path = '/Volumes/Nicola Projects SSD1TB/graphs/' + graphs_location + '/tracking_file.json'
    working_directory = os.getcwd()
    audio_files_dir = working_directory + audio_files_subdir
    audio_files_dir = '/Users/nicola/Documents/MSc SOund Design 20-24/Final Project/Sound/Audio_Files'
    graphs_dir = '/Volumes/Nicola Projects SSD1TB/graphs/' + graphs_location
